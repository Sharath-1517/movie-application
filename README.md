...
# How to use the code
  ...
  - ## Step-1: Setting up the database
    ...
    - Go to this link provided ([LINK](https://github.com/Sharath-1517/movie-application/blob/main/_data/movies.json)) and click `WIN + S` and save that file in your preferrable location in your computer.
