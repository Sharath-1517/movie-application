...
# How to use the code
  ...
  - ## Step-1: Setting up the database
    ...
    - Go to this link provided ([LINK](https://raw.githubusercontent.com/Sharath-1517/movie-application/main/_data/movies.json?token=GHSAT0AAAAAACBLBP2D5NLTOEQBTFSG4PWKZCSECGA)) and click `WIN + S` and save that file in your preferrable location in your computer.
